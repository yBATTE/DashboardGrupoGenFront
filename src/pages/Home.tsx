    ...
    <>
      <div className="card" style={{display:'flex', justifyContent:'space-between', alignItems:'center', gap:12}}>
        <div>
          ...
          <div className="h1" style={{margin:0}}>Preparando tu resumen…</div>
        </div>
        <div className="chips">
          <span className="chip">Hoy: —</span>
          <span className="chip">Vencidas: —</span>
      ...
      <div className="grid grid-3" style={{marginTop:12}}>
        <div className="card"><div className="card-title">Tareas de hoy</div><div className="muted">Cargando…</div></div>
        <div className="card"><div className="card-title">Tareas vencidas</div><div className="muted">Cargando…</div></div>
        <div className="card"><div className="card-title">Mis equipos</div><div className="muted">Cargando…</div></div>
      </div>

      <div className="grid grid-3" style={{marginTop:12}}>
        <div className="card"><div className="card-title">Pagos que vencen pronto (≤72 h)</div><div className="muted">Cargando…</div></div>
        <div className="card"><div className="card-title">Pagos vencidos</div><div className="muted">Cargando…</div></div>
        <div className="card"><div className="card-title">Accesos rápidos</div><div className="muted">Cargando…</div></div>
      </div>
    </>
  );
}
...
export default function Home() {
  ...
  const bootLoading =
    (!tasks && tLoading) || (!payments && pLoading) || (!teams && teamsLoading);
                    ...
                    <li key={p._id}>
                      <Link to={`/payments/${p._id}`} className="no-underline" style={{color:'inherit'}}>
                        <div style={{fontWeight:800}}>
                          {p.title} <span className="muted" style={{fontWeight:600}}>· {currency(p.amount)}</span>
                        </div>
                        <div className="muted" style={{fontSize:12}}>
